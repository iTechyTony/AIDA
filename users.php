...
<div class="container-fluid">
 ...
 <?php require_once 'templates/_leftnav.php'; ?>  
    <div class="col-md-9">
<?php echo '<link rel="stylesheet" href="assets/css/dataTables.bootstrap.css"/>'; ?>
              <a class="btn btn-primary" href="javascript:void(0);" 
                  onclick="users.showAddUserModal()" > 
                  <i class="icon-user icon-white glyphicon glyphicon-user"></i>
                  <?php echo AIDALang::get('add_user'); ?>
              </a>
              <?php //user_role 3 => admin ?>
              <?php $users = $db->select("SELECT * FROM `as_users` WHERE `user_role` != '3' ORDER BY `register_date` DESC"); ?>
              <table class="table table-striped users-table" id="users-list" >
                  <thead>
                  <tr>
                  <th><?php echo AIDALang::get('username'); ?></th>
                  <th><?php echo AIDALang::get('email'); ?></th>
                  <th><?php echo AIDALang::get('register_date'); ?></th>
                 
<!--                  <th>--><?php //echo AIDALang::get('last_login'); ?><!--</th>-->
                  <th><?php echo AIDALang::get('confirmed'); ?></th>
                  <th><?php echo AIDALang::get('action'); ?></th>
                   </tr>
                  </thead>
                  <?php foreach ($users as $user): ?>
                      <?php $tmpUser = new AIDAUser($user['user_id']); ?>
...
<!--                          <td>--><?php //echo $user['last_login']; ?><!--</td>-->
                          <td>
                              <?php echo $user['confirmed'] == "Y"
                                  ? "<p class='text-success'>" . AIDALang::get('yes') . "</p>"
                                  : "<p class='text-error'>" . AIDALang::get('no') . "</p>"
                              ?>
                          </td>
                          <td>
                              <div class="btn-group">
                                  ...
                                  <ul class="dropdown-menu">
                                          ...
                                          <li>
                                              <a href="javascript:void(0);"
                                                 onclick="users.unbanUser(this,<?php echo $user['user_id'];  ?>);">
                                                  ...
                                                  <span><?php echo AIDALang::get('unban'); ?></span>
                                              </a>
                                          </li>
                                      <?php else: ?>
                                          <li>
                                              <a href="javascript:void(0);"
                                                 onclick="users.banUser(this,<?php echo $user['user_id'];  ?>);">
                                                  <i class="icon-ban-circle glyphicon glyphicon-ban-circle"></i>
                                                  <span><?php echo AIDALang::get('ban'); ?></span>
                                              </a>
                                          </li>
                                      <?php endif; ?>
                                      ...
                                      <li>
                                          <a href="javascript:void(0);"
                                             onclick="users.roleChanger(this,<?php echo $user['user_id'];  ?>);">
                                              <i class="i"></i> <?php echo AIDALang::get('change_role'); ?></a>
                                      </li>
                                  </ul>
                              </div>
                          </td>
    ...
    <?php require_once 'templates/_footer.php'; ?>
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="modal-username">
                    <?php echo AIDALang::get('loading'); ?>
                  </h4>
                </div>
                <div class="modal-body" id="details-body">
                  <dl class="dl-horizontal">
                    <dt title="<?php echo AIDALang::get('email'); ?>"><?php echo AIDALang::get('email'); ?></dt>
                    <dd id="modal-email"></dd>
                    <dt title="<?php echo AIDALang::get('first_name'); ?>"><?php echo AIDALang::get('first_name'); ?></dt>
                    <dd id="modal-first-name"></dd>
                    <dt title="<?php echo AIDALang::get('last_name'); ?>"><?php echo AIDALang::get('last_name'); ?></dt>
                    <dd id="modal-last-name"></dd>
                    <dt title="<?php echo AIDALang::get('address'); ?>"><?php echo AIDALang::get('address'); ?></dt>
                    <dd id="modal-address"></dd>
                    <dt title="<?php echo AIDALang::get('phone'); ?>"><?php echo AIDALang::get('phone'); ?></dt>
                    <dd id="modal-phone"></dd>
                    <dt title="<?php echo AIDALang::get('last_login'); ?>"><?php echo AIDALang::get('last_login'); ?></dt>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                  <h4 class="modal-title" id="modal-username">
                    <?php echo AIDALang::get('pick_user_role'); ?>
                  </h4>
                </div>
                <div class="modal-body" id="details-body">
                    <?php $roles = $db->select("SELECT * FROM `as_user_roles` WHERE `role_id` <> '3'"); ?>
                    <?php if(count($roles) > 0): ?>
                      <p><?php echo AIDALang::get('select_role'); ?>:</p>
                    ...
                    <form class="form-horizontal" id="add-user-form">
                      ...
                      <div class="control-group form-group">
                        <label class="control-label col-lg-3" for="adduser-username">
                          <?php echo AIDALang::get('username'); ?>
                        </label>
                        <div class="controls col-lg-9">
                      ...
                      <div class="control-group form-group">
                        <label class="control-label col-lg-3" for="adduser-password">
                          <?php echo AIDALang::get('password'); ?>
                        </label>
                        <div class="controls col-lg-9">
                      ...
                      <div class="control-group form-group">
                        <label class="control-label col-lg-3" for="adduser-confirm_password">
                          <?php echo AIDALang::get('repeat_password'); ?>
                        </label>
                        <div class="controls col-lg-9">
        ...
        <script src="lib/js/users.js" type="text/javascript" charset="utf-8"></script>
