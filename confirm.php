...
<html lang="en"> 
    <head>
        <meta charset="UTF-8">
        <title><?php echo AIDALang::get('email_confirmation'); ?> | Advanced Internet Development</title>
                        ...
                        <div class="modal-body">
                            <div class="well">
                                ...
                                if (count($result) == 1) {
                                    ...
                                    echo "<h4 class='text-success'>". AIDALang::get('email_confirmed') .".</h4>";
                                    echo "<h5 class='text-success'>". AIDALang::get('you_can_login_now', array( 'link' => 'login.php') ) ."</h5>";
                                }
                                else
                                    echo "<h5 class='text-error'>". AIDALang::get('user_with_key_doesnt_exist') ."</h5>";
                                ?>
                            </div>
                        </div>
                    </div>
