...
switch ($action) {
	...
	case "postComment":
		$ASComment = new AIDAComment();
		echo $ASComment->insertComment(AIDASession::get("user_id"), $_POST['comment']);
		break;
	...
	case "changeRole":
		...
		$user = new AIDAUser($_POST['userId']);
...
function onlyAdmin() {
	...
	$loggedUser = new AIDAUser(AIDASession::get("user_id"));
